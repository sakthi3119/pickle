...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // For development mode, allow any login with basic validation
      if (typeof import.meta !== 'undefined' && import.meta.env?.DEV) {
        ...
        // Create user data for development
        const userData = {
          id: 1,
          name: 'Admin User',
              ...
              <div className="flex">
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-yellow-700">
                    <p>You're in development mode. Any email/password combination will work for testing.</p>
                  </div>
                </div>
              </div>
            </div>
