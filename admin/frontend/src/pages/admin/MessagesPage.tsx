      ...
      const sampleMessages = [
        {
          ...
          message: 'Hi, I was wondering about the ingredients in your Classic Dill Pickles. Are they gluten-free?',
          status: 'unread',
        ...
        },
        {
          ...
          message: 'I placed an order last week and haven\'t received a shipping confirmation yet. Can you help me track it?',
          status: 'read',
        ...
        },
        {
          ...
          message: 'I\'m interested in placing a bulk order for our restaurant. Do you offer wholesale pricing?',
          status: 'unread',
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {messages.map((message) => (
                <tr key={message._id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`inline-flex px-2 py-1 text-xs font-medium rounded-full ${message.status === 'read' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'
                      }`}>
                      {message.status}
                    </span>
                  </td>
